...
const (
	NUM   StrType = iota // Number
	LOWER                // lowercase letters
	UPPER                // Uppercase letters
	ALL                  // All
	CLEAR                // Remove some confusing characters.
)
...
// SetFont Set Font Multiple fonts can be set.
...
// Create to generate a CAPTCHA image.
